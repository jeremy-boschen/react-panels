...
- Fixed initial style calculation for dynamically added panels (panels no longer start with `height: "0px"`)
- Ensured `originalUnitsRef` stays synchronized when panels are added or removed dynamically
